...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title = "Employee Engagement Assessment | Incentric";
  ...
  return {
    ...
    openGraph: { title, description, images: [{ url: image, width: 1200, height: 630, alt: "Incentric Employee Engagement Assessment" }] },
